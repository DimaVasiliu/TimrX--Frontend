      ...
      <div class="card video-header-card">
        <div class="video-header-row">
          <div class="video-provider-switcher" id="videoProviderSwitcher">
            ...
            <button type="button" class="video-provider-btn disabled" data-provider="seedance" disabled title="Seedance 2.0 is temporarily unavailable"><span class="vpb-name">Seedance 2.0</span><span class="vpb-tag">Unavailable</span></button>
          </div>
