...
(function () {
  ...
  function footer() {
    ...
    return ''
      ...
      + '          <img src="' + resolveAssetHref(brandModel.logo || 'img/logo.png') + '" alt="TimrX" width="40" height="40">'
      + '          <span class="site-shell-footer-name"><span>' + escapeHtml(brandModel.wordmarkLead || 'Timr') + '</span><span class="site-shell-footer-name-x">' + escapeHtml(brandModel.wordmarkAccent || 'X') + '</span></span>'
      + '        </a>'
      ...
      + '      <a href="' + resolveInternalHref('/dima-vasiliu') + '">Built by Dima Vasiliu <span aria-hidden="true">↗</span></a>'
      + '    </div>'
      + '  </div>'
      + '</footer>';
  }
