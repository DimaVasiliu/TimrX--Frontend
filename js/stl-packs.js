/* ============================================================
   ...
   image: optional preview render in /img/stl-previews/. Leave '' for a
          generated gradient placeholder card.
   ============================================================ */
(function () {
  'use strict';

  const STL_PACK_ASSET_VERSION = '20260522b';
  ...
  const STL_PACKS = [
    { slug: 'airplanes', title: 'Airplanes STL Pack', category: 'Vehicles',
      ...
      priceGBP: 3.99, fileCount: 42, sizeMB: 1100, r2Key: 'airplanes.zip', image: 'img/stl-previews/airplanes.webp',
    ...
    { slug: 'animals', title: 'Animals STL Pack', category: 'Animals',
      ...
      priceGBP: 3.99, fileCount: 138, sizeMB: 0, r2Key: 'animals.zip', image: 'img/stl-previews/animals.webp',
    ...
    { slug: 'anime', title: 'Anime STL Pack', category: 'Characters',
      ...
      priceGBP: 3.99, fileCount: '100+', sizeMB: 0, r2Key: 'anime.zip', image: 'img/stl-previews/anime.webp',
    ...
    { slug: 'articulated-toys', title: 'Articulated Toys Pack', category: 'Toys',
      ...
      priceGBP: 3.99, fileCount: 173, sizeMB: 0, r2Key: 'articulated-toys.zip', image: 'img/stl-previews/articulated-toys.webp',
    ...
    { slug: 'games', title: 'Games STL Pack', category: 'Gaming',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'games.zip', image: 'img/stl-previews/games.webp',
    ...
    { slug: 'busts', title: 'Busts STL Pack', category: 'Characters',
      ...
      priceGBP: 3.99, fileCount: 182, sizeMB: 0, r2Key: 'busts.zip', image: 'img/stl-previews/busts.webp',
    ...
    { slug: 'scenes', title: 'Scenes STL Pack', category: 'Scenes',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'scenes.zip', image: 'img/stl-previews/scenes.webp',
    ...
    { slug: 'chibi', title: 'Chibi STL Pack', category: 'Characters',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'chibi.zip', image: 'img/stl-previews/chibi.webp',
    ...
    { slug: 'keychains', title: 'Keychains STL Pack', category: 'Home & Decor',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'keychains.zip', image: 'img/stl-previews/keychains.webp',
    ...
    { slug: 'cosplay', title: 'Cosplay STL Pack', category: 'Characters',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'cosplay.zip', image: 'img/stl-previews/cosplay.webp',
    ...
    { slug: 'dc', title: 'DC STL Pack', category: 'More',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'dc.zip', image: 'img/stl-previews/dc.webp',
    ...
    { slug: 'decorations', title: 'Decorations STL Pack', category: 'Home & Decor',
      ...
      priceGBP: 4.99, fileCount: 66, sizeMB: 500, r2Key: 'decorations.zip', image: 'img/stl-previews/decorations.webp',
    ...
    { slug: 'animated-cartoons', title: 'Animated Cartoons STL Pack', category: 'Characters',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'animated-cartoons.zip', image: 'img/stl-previews/animated-cartoons.webp',
    ...
    { slug: 'disney', title: 'Disney STL Pack', category: 'Characters',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'disney.zip', image: 'img/stl-previews/disney.webp',
    ...
    { slug: 'sculptures', title: 'Sculptures STL Pack', category: 'Characters',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'sculptures.zip', image: 'img/stl-previews/sculptures.webp',
    ...
    { slug: 'dioramas', title: 'Dioramas STL Pack', category: 'Scenes',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'dioramas.zip', image: 'img/stl-previews/dioramas.webp',
    ...
    { slug: 'foldable', title: 'Foldable STL Pack', category: 'Toys',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'foldable.zip', image: 'img/stl-previews/foldable.webp',
      tags: ['foldable', 'flexi', 'flexible'] },
    { slug: 'film', title: 'Film STL Pack', category: 'Film',
      blurb: 'Models and props inspired by film and TV.',
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'film.zip', image: 'img/stl-previews/film.webp',
    ...
    { slug: 'mythological', title: 'Mythological STL Pack', category: 'Characters',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'mythological.zip', image: 'img/stl-previews/mythological.webp',
    ...
    { slug: 'multipart', title: 'Multipart STL Pack', category: 'Miniatures',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'multipart.zip', image: 'img/stl-previews/multipart.webp',
    ...
    { slug: 'religion', title: 'Religion STL Pack', category: 'Religion',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'religion.zip', image: 'img/stl-previews/religion.webp',
    ...
    { slug: 'vehicles', title: 'Vehicles STL Pack', category: 'Vehicles',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'vehicles.zip', image: 'img/stl-previews/vehicles.webp',
    ...
    { slug: 'supports', title: 'Supports STL Pack', category: 'More',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'supports.zip', image: 'img/stl-previews/supports.webp',
    ...
    { slug: 'table-games', title: 'Table Games STL Pack', category: 'Gaming',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'table-games.zip', image: 'img/stl-previews/table-games.webp',
    ...
    { slug: 'utensils', title: 'Utensils STL Pack', category: 'Home & Decor',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'utensils.zip', image: 'img/stl-previews/utensils.webp',
    ...
    { slug: 'miniatures', title: 'Miniatures STL Pack', category: 'Miniatures',
      ...
      priceGBP: 3.99, fileCount: 40, sizeMB: 0, r2Key: 'miniatures.zip', image: 'img/stl-previews/miniatures.webp',
