...
export const PROVIDER_CAPABILITIES = {
  image: {
    nano_banana: {
      ...
      credits: 2,   // PREMIUM provider
      creditsByQuality: { standard: 2, high: 2, '4k': 3 },
    ...
    nano_banana_pro: {
      ...
      defaultOutputMode: 'raster',
      credits: 3,
      creditsByQuality: { standard: 3, high: 3, '4k': 5 },
    ...
    openai: {
      ...
      defaultOutputMode: 'raster',
      credits: 2,
      creditsByQuality: { standard: 2, high: 2, '4k': 2 },
    ...
    google: {
      ...
      defaultOutputMode: 'raster',
      credits: 2,
      creditsByQuality: { standard: 2, high: 3, '4k': 3 },
      genTimeByQuality: { standard: '30 sec', high: '45 sec' },
      genTime: '30 sec',
    ...
    ideogram_v3: {
      ...
      defaultOutputMode: 'raster',
      credits: 2,
      creditsByQuality: { standard: 2, high: 3 },
